...
use App\Admin\Extensions\ContractsExporter;
...
class ContractController extends Controller
{
    ...
    protected function grid()
    {
        ...
        $grid->exporter(new ContractsExporter());
        $grid->id('Id');
    ...
    protected function detail($id)
    {
        ...
        $show->id('Thông Tin Chi Tiết')->as(function ($id) {
    ...
    protected function form()
    {
        ...
        $form->hasMany('product_list', 'Danh Sách Sản Phẩm', function (Form\NestedForm $form) {
            ...
            $form->datetime('selected_at', 'Ngày Bảo Trì')->default(date('Y-m-d H:i:s'));
        });
